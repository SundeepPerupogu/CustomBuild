  ...
  return {
    ...
    arguments: {
      execute: {
        ...
        url: `https://discount-3wj3.onrender.com/modules/discount-code/execute`,
    ...
    configurationArguments: {
      publish: {
        url: `https://discount-3wj3.onrender.com/modules/discount-code/publish`
      },
      validate: {
        url: `https://discount-3wj3.onrender.com/modules/discount-code/validate`
      },
      stop: {
        url: `https://discount-3wj3.onrender.com/modules/discount-code/stop`
      }
    },
    userInterfaces: {
